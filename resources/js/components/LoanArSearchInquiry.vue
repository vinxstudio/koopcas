        ...
        <form>
            <div class="form-row mb-4 mt-2 align-items-center">
                ...
                <div class="col-sm-3 mr-3">
                    <input class="form-control form-control-sm" v-model="search" name="search" placeholder="Enter Client's ID" type="text">
                </div>
        ...
        <table class="table table-sm table-bordered table-hover custom-table" v-if="this.$route.params.id">
            ...
            <tbody>
                <tr v-for="armaster in armasters" v-bind:key="armaster.id">
                    ...
                    <td><router-link v-bind:to="'/loans/armaster-inquiry/'+armaster.arBrCode+'/'+armaster.arSlcCode+'/'+armaster.arSltCode+'/'+armaster.arRefNo+'/'+armaster.clientIdAr">View AR Master</router-link></td>
                </tr>
            </tbody>
        </table>
        ...
        <table class="table table-sm table-bordered table-hover custom-table" v-else>
            ...
            <tbody>
                <tr v-for="clientloan in clientloans" v-bind:key="clientloan.id">
                    ...
                    <td><router-link v-bind:to="'/loans/armaster-inquiry/'+clientloan.clientId">View Loan</router-link></td>
                </tr>
            </tbody>
        </table>
