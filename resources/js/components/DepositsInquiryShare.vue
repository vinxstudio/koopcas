    ...
    <nav class="navbar navbar-expand-lg p-0" id="toolbar">
      ...
      <ul class="navbar-nav ml-auto">
        <li class="nav-item">
          <!--added router-->
          <router-link
            v-bind:to="'/deposits/inquiry-share-search/'+client.clientId+'/inquiry-share-search-deposit'"
          ...
          <!--added v-else-->
          <router-link
            to="/deposits/inquiry-share-search"
            class="btn btn-sm btn-outline-primary mr-4"
            v-else
          >
            <i class="fa fa-search mr-1"></i>
              ...
              <div class="col-md-7">
                <div class="form-row justify-content-between">
                  <div class="col-sm-4 my-1">
                    ...
                    <input
                      class="form-control form-control-sm bg-light-green border-0"
                      v-model="sharecapital.clientIdSc"
                      name="clientIdSc"
                      type="text"
                      readonly
                      v-else-if="this.$route.params.scBrCode && this.$route.params.scSlcCode && this.$route.params.scSltCode && this.$route.params.scRefNo && this.$route.params.clientIdSc"
                    >
                    <input
                      class="form-control form-control-sm bg-light-green border-0"
                      v-model="sharecapital.clientIdSc"
                ...
                <div class="form-row justify-content-between">
                  ...
                  <div class="col-sm my-1">
                    ...
                    <input
                      class="form-control form-control-sm"
                      v-model="sharecapital.firstName"
                      name="firstName"
                      type="text"
                      readonly
                      v-else-if="this.$route.params.scBrCode && this.$route.params.scSlcCode && this.$route.params.scSltCode && this.$route.params.scRefNo && this.$route.params.clientIdSc"
                  ...
                  <div class="col-sm my-1">
                    ...
                    <input
                      class="form-control form-control-sm"
                      v-model="sharecapital.middleName"
                      name="middleName"
                      type="text"
                      readonly
                      v-else-if="this.$route.params.scBrCode && this.$route.params.scSlcCode && this.$route.params.scSltCode && this.$route.params.scRefNo && this.$route.params.clientIdSc"
                ...
                <div class="form-row mb-2 justify-content-between">
                  <fieldset class="col-sm my-1 border pb-3 px-3 mx-1">
                    ...
                    <input
                      class="form-control form-control-sm"
                      v-model="sharecapital.accountName"
                      name="accountName"
                      type="text"
                      readonly
                      v-else-if="this.$route.params.scBrCode && this.$route.params.scSlcCode && this.$route.params.scSltCode && this.$route.params.scRefNo && this.$route.params.clientIdSc"
                  ...
                  <fieldset class="col-md-3 col-sm-4 my-1 border pb-3 px-3 mx-1">
                    ...
                    <input
                      class="form-control form-control-sm"
                      v-model="sharecapital.dateOpened"
                      name="dateOpened"
                      type="date"
                      readonly
                      v-else-if="this.$route.params.scBrCode && this.$route.params.scSlcCode && this.$route.params.scSltCode && this.$route.params.scRefNo && this.$route.params.clientIdSc"
              ...
              <div class="col-md-5">
                ...
                <div class="form-row">
                  ...
                  <div class="col-sm-6 my-1">
                    ...
                    <select
                      class="custom-select custom-select-sm"
                      v-model="sharecapital.jointType"
                      name="jntType"
                      disabled
                      v-else-if="this.$route.params.scBrCode && this.$route.params.scSlcCode && this.$route.params.scSltCode && this.$route.params.scRefNo && this.$route.params.clientIdSc"
                    >
                ...
                <div class="form-row">
                  ...
                  <div class="col-sm-6 my-1">
                    ...
                    <select
                      class="custom-select custom-select-sm"
                      v-model="sharecapital.clientType"
                      name="acctType"
                      disabled
                      v-else-if="this.$route.params.scBrCode && this.$route.params.scSlcCode && this.$route.params.scSltCode && this.$route.params.scRefNo && this.$route.params.clientIdSc"
                    >
                ...
                <div class="form-row">
                  ...
                  <div class="col-sm-6 my-1">
                    ...
                    <select
                      class="custom-select custom-select-sm"
                      v-model="sharecapital.accountStatus"
                      name="accountStatus"
                      disabled
                      v-else-if="this.$route.params.scBrCode && this.$route.params.scSlcCode && this.$route.params.scSltCode && this.$route.params.scRefNo && this.$route.params.clientIdSc"
                    >
                ...
                <div class="col">
                  <div class="form-row">
                    ...
                    <div class="col-sm my-1">
                      <select
                        class="custom-select custom-select-sm"
                        v-model="sharecapital.scSltCode"
                        name="scSltCode"
                        :disabled="selectDisabled"
                      >
                        <option disabled>(select one)</option>
                        <option
                          v-for="depositDepositType in depositDepositTypes"
                          v-bind:value="depositDepositType.slTypeSltCode"
                        >{{ depositDepositType.slTypeMDesc }}</option>
                      </select>
                    </div>
                  </div>
                </div>
                ...
                <div class="col">
                  ...
                  <div class="form-row">
                    ...
                    <div class="col-sm my-1">
                      <select
                        class="custom-select custom-select-sm"
                        v-model="sharecapital.scStatus"
                        name="scStatus"
                        :disabled="selectDisabled"
                      >
                        <option disabled>(select one)</option>
                        <option
                          v-for="depositDepositStatuses in depositDepositStatuses"
                          v-bind:value="depositDepositStatuses.ctsTypeCode"
                        >{{ depositDepositStatuses.ctsTypeDesc }}</option>
                      </select>
                    </div>
                  </div>
                </div>
          ...
          <div class="tab-content">
            <div role="tabpanel" class="tab-pane active" id="holdouts">
              <div class="form-row justify-content-between">
                ...
                <div class="col-sm my-1">
                  ...
                  <select
                    class="custom-select custom-select-sm"
                    v-model="sharecapital.holdReason"
                    name="holdReason"
                    :disabled="selectDisabled"
                  >
                    <option disabled>(select one)</option>
                    <option
                      v-for="depositHoldCode in depositHoldCodes"
                      v-bind:value="depositHoldCode.holdCodeId"
                    >{{ depositHoldCode.holdCodeDesc }}</option>
                  </select>
                </div>
              </div>
            ...
            <div role="tabpanel" class="tab-pane" id="remarks">
              <textarea
                ...
                cols="30"
                id
                v-model="sharecapital.scRemarks"
                name="scRemarks"
                rows="10"
                :readonly="readOnly"
              ></textarea>
