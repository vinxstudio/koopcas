<template>
  <div class="bpr-maintenance-search">
        ...
        <fieldset class="border p-4 bg-light">
          ...
          <div class="form-row justify-content-center">
            <div class="col-auto">
              ...
              <router-link
                to="/back-office/bpr-maintenance"
    ...
    <table class="table table-sm table-bordered table-hover custom-table">
      ...
      <tbody>
        <tr v-for="transsum in transsums" v-bind:key="transsum.id">
          ...
          <td>
            <router-link
              v-bind:to="'/back-office/bpr-maintenance/'+transsum.trCode+'/'+transsum.trYear+'/'+transsum.trCtlNo+'/'+transsum.trDocNo"
