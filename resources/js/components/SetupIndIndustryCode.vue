<template>
  <div class="industry-industry-code">
    ...
    <div class="form-row justify-content-center pt-3">
      <fieldset class="border w-50 mt-3">
        <div class="col-md-12 mt-3">
          <div class="form-row">
            <label
              class="col-md col-form-label col-form-label-sm mt-1 text-sm-right text-truncate"
            >Division(Economic Activity):</label>
          ...
          <div class="form-row">
            ...
            >Section(Nature of Business):</label>
          ...
          <div class="form-row">
            <label
              class="col-md-4 col-form-label col-form-label-sm mt-1 text-sm-right text-truncate"
            >Section List-Division List</label>
            <div class="col-md-8 my-1">
              <textarea class="form-control form-control-sm" style="height:200px" name type="text"></textarea>
            </div>
          </div>
        </div>
        <br>
