...
<div class="accounts-payable">
    ...
    <nav class="navbar navbar-expand-lg p-0" id="toolbar">
      ...
      <ul class="navbar-nav ml-auto">
        <li class="nav-item">
          <router-link
            v-bind:to="'/other-mod/oslsearch/'+client.clientId+'/inquiry-sl-search'"
          ...
          <router-link
            to="/other-mod/inquiry-sl-search"
            class="btn btn-sm btn-outline-primary mr-4"
            v-else
          >
            <i class="fa fa-search mr-1"></i>
    ...
    <form @submit.prevent="insertOsl">
            ...
            <div class="tab-content">
              ...
              >
                <div class="form-row justify-content-between">
                  ...
                  >Account Name:</label>
                  <div class="col-sm my-1">
                    <select class="custom-select custom-select-sm" name="depositType">
      ...
      <div class="d-flex justify-content-center" style="margin-bottom: 20px; margin-top: 20px;">
        ...
        >
          <router-link
            to="/other-mod/inquiry-subsidiary-ledger"
            class="new"
            :disabled="selectDisabled"
          >
            <i class="fa fa-times-circle mr-1"></i>
...
export default {
  ...
  methods: {
    ...
    insertOsl() {
      ...
      } else if (this.$route.params.oslBrCode && this.$route.params.oslSlcCode && this.$route.params.oslSltCode && this.$route.params.oslRefNo && this.$route.params.clientIdOsl) {
