  ...
  <div class="ar-master">
    <nav class="navbar navbar-expand-lg p-0" id="toolbar">
      ...
      <ul class="navbar-nav ml-auto">
        <li class="nav-item">
          <router-link
            v-bind:to="'/loans/loan-ar-master/'+client.clientId+'/ar-search-loan'"
          ...
          <button
            class="btn btn-sm btn-outline-primary mr-1"
            type="button"
            v-else-if="this.$route.params.arBrCode && this.$route.params.arSlcCode && this.$route.params.arSltCode && this.$route.params.arRefNo && this.$route.params.clientIdAr"
            @click="insertNew"
          >
            <i class="fa fa-file mr-1"></i>
            <span>
          ...
          <button
            class="btn btn-sm btn-outline-primary mr-1"
            type="button"
            v-if="this.$route.params.arBrCode && this.$route.params.arSlcCode && this.$route.params.arSltCode && this.$route.params.arRefNo && this.$route.params.clientIdAr"
            @click="editAr(loanar)"
          >
    ...
    <div
      ...
      v-if="successAdd"
      transition="expand"
    >AR Master Successfully Added.</div>

    <div
      class="alert alert-success"
      v-if="successEdit"
      transition="expand"
    >AR Master Successfully Updated.</div>
    ...
    <form @submit.prevent="insertAr">
          ...
          <div class="tab-content">
            <div role="tabpanel" class="tab-pane active" id="duedates">
              ...
              <div class="form-row">
                <label
                  class="col-sm-3 col-form-label col-form-label-sm mt-1 text-sm-right text-truncate"
                >Use Actual No. of Days</label>
                <div class="col my-1">
                  <select
                    class="custom-select custom-select-sm"
                    id
                    v-model="loanar.arNdFlag"
                    name="arNdFlag"
                    :disabled="selectDisabled"
                  >
      ...
      <div class="d-flex justify-content-center" style="margin-bottom: 20px; margin-top: 20px;">
        <button class="btn btn-sm btn-secondary mr-1" type="submit" v-if="selectDisabled">
          <i class="fa fa-save mr-1"></i>
          <span>
            <u>S</u>ave
          </span>
        </button>
        <button class="btn btn-sm btn-success mr-1" type="submit" v-else :disabled="selectDisabled">
          <i class="fa fa-save mr-1"></i>
          <span>
            <u>S</u>ave
          </span>
        ...
        <button class="btn btn-sm btn-secondary" type="button" v-if="selectDisabled">
          <i class="fa fa-times-circle mr-1"></i>
          <span>
            Canc
            <u>e</u>l
        ...
        <button
          ...
          @click="cancel"
        >
          <router-link to="/loans/loan-ar-master" class="new" :disabled="selectDisabled">
            <i class="fa fa-times-circle mr-1"></i>
            <span>
              Canc
              <u>e</u>l
...
export default {
  ...
  methods: {
    fetchArMaster(arBrCode, arSlcCode, arSltCode, arRefNo, clientIdAr) {
      fetch(
        `/api/ar/${arBrCode}/${arSlcCode}/${arSltCode}/${arRefNo}/${clientIdAr}`
      )
        .then(res => res.json())
        .then(res => {
      ...
      if (this.edit === false) {
        ...
        fetch("/api/ar", {
          ...
          .then(res => {
            ...
            this.fetchArMaster(
              this.$route.params.arBrCode,
              this.$route.params.arSlcCode,
              this.$route.params.arSltCode,
              this.$route.params.arRefNo,
              this.$route.params.clientIdAr
            );
          })
          .catch(err => console.log(err));
      }
