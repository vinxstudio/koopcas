<template>
  <div class="maintenance-patronage-search">
      ...
      <div class="col-md-5">
        <fieldset class="border p-4 bg-light">
          <div class="form-row justify-content-center">
            ...
            <div class="col my-1">
              <select
                class="col-md-6 custom-select custom-select-sm"
                name="transType"
                v-model="maintenancepatronage.transType"
              >
                <option
