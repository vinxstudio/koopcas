    ...
    <nav class="navbar navbar-expand-lg p-0" id="toolbar">
      ...
      <ul class="navbar-nav ml-auto">
        ...
        <li class="nav-item">
          <!--added router-->
          <router-link
            v-bind:to="'/deposits/time-maintenance-search/'+client.clientId+'/time-maintenance-search-deposit'"
          ...
          <!--added v-else-->
          <router-link
            to="/deposits/time-maintenance-search"
            class="btn btn-sm btn-outline-primary mr-4"
            v-else
          >
            <i class="fa fa-search mr-1"></i>
          ...
          <button class="btn btn-sm btn-outline-secondary mr-1" type="submit">
