          ...
          <div class="row">
            <div class="col-md-6">
              <div class="form-group">
                ...
                <select name="branchAllocation" v-model="playtosavestabsall.branchAllocation" class="form-control" :disabled="selectDisabled">
              ...
              <div class="form-group">
                <div class="row">
                  <div class="col-md-6">
                    ...
                    <input type="number" name="serialNumberStart" v-model="playtosavestabsall.serialNumberStart" class="form-control" :readonly="readOnly">
                  </div>

                  <div class="col-md-6">
                    <label for="">Serial Number End</label>
                    <input type="number" name="serialNumberEnd" v-model="playtosavestabsall.serialNumberEnd" class="form-control" :readonly="readOnly">
                  </div>
                </div>
              </div>
            </div>
          ...
          <div class="row">
            <div class="col-md-6">
              <div class="form-group">
                ...
                <input type="number" name="quantity" v-model="playtosavestabsall.quantity" class="form-control" :readonly="readOnly">
              </div>
            </div>
            ...
            <div class="col-md-6">
              <div class="form-group">
                ...
                <input type="date" name="dateAdded" v-model="playtosavestabsall.dateAdded" class="form-control" :readonly="readOnly">
              </div>
            </div>
          </div>
...
export default {
  ...
  methods: {
    ...
    insertStabs() {
      fetch("/api/playtosaveserialstabsall", {
        method: "post",
        body: JSON.stringify(this.playtosavestabsall),
        headers: { "content-type": "application/json" }
      })
      .then(res => {
        this.playtosavestabsall.branchAllocation = "";
        this.playtosavestabsall.serialNumberStart = "";
        this.playtosavestabsall.serialNumberEnd = "";
        this.playtosavestabsall.quantity = "";
        this.playtosavestabsall.serialNumber = "";
    ...
    newStabs() {
      ...
      this.playtosavestabsall.serialNumber = "";
      this.playtosavestabsall.quantity = "";
      this.playtosavestabsall.dateAdded = moment(new Date).format('YYYY-MM-DD');
      this.playtosavestabsall.dateTimeAdded = moment(new Date).format('YYYY-MM-DD hh:mm:ss');
    },
