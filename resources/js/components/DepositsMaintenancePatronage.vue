  ...
  <div class="Patronage">
    <nav class="navbar navbar-expand-lg p-0" id="toolbar">
      ...
      <ul class="navbar-nav ml-auto">
        <li class="nav-item">
          <router-link
            v-bind:to="'/deposits/maintenance-patronage-search/'+client.clientId+'/maintenance-patronage-search-deposit'"
          ...
          <!--added v-else-->
          <router-link
            to="/deposits/maintenance-patronage-search"
            class="btn btn-sm btn-outline-primary mr-4"
            v-else
          >
            <i class="fa fa-search mr-1"></i>
      ...
      <div class="col-sm-3">
        <fieldset class="bg-light border p-2 h-100">
          <div class="form-row">
            ...
            <div class="col my-1">
              <input class="form-control form-control-sm" name="refNo" type="number">
            </div>
          </div>
          <div class="form-row">
            <label
