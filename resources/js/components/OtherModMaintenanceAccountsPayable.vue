  ...
  <div class="accounts-payable">
    <nav class="navbar navbar-expand-lg p-0" id="toolbar">
      ...
      <ul class="navbar-nav ml-auto">
        <li class="nav-item">
          <router-link
            v-bind:to="'/other-mod/apsearch/'+client.clientId+'/maintenance-ap-search'"
          ...
          <router-link
            to="/other-mod/maintenance-ap-search"
            class="btn btn-sm btn-outline-primary mr-4"
            v-else
          >
            <i class="fa fa-search mr-1"></i>
            ...
            <ul role="tablist" class="nav nav-tabs nav-fill">
              <li class="nav-item">
                <a
                  ...
                  role="tab"
                  id="ngb-tab-23"
                  aria-controls="ngb-tab-23-panel"
                  aria-expanded="true"
                  aria-disabled="false"
                >
                  <span>
              ...
              >
                ...
                <div class="form-row mt-4 align-items-center">
                  ...
                  <div class="form-row">
                    ...
                    <div class="form-row">
                      <label
                        class="col-md-4 col-sm-5 col-form-label col-form-label-sm mt-1 text-sm-right text-truncate font-weight-bold"
                        for="minBalance"
                      >Amortization:</label>
                      <div class="col-sm my-1">
                        <input
                          class="form-control form-control-sm text-right"
                          v-model="accountspayable.apAmortzn"
                          name="apAmortzn"
                          type="text"
                          readonly
                        >
