      ...
      <nav class="navbar navbar-expand-lg p-0" id="toolbar">
        ...
        <ul class="navbar-nav ml-auto">
          <li class="nav-item">
            <!--added router-->
            <router-link
              v-bind:to="'/deposits/tdsearch/'+client.clientId+'/inquiry-time-search'"
            ...
            <!--added v-else-->
            <router-link
              to="/deposits/inquiry-time-search"
              class="btn btn-sm btn-outline-primary mr-4"
              v-else
            >
              <i class="fa fa-search mr-1"></i>
                        ...
                        <div class="form-row">
                          ...
                          <div class="col my-1">
                            <select
                              class="custom-select custom-select-sm"
                              id
                              v-model="timedeposit.tdTermPerds"
                              name="tdTermPerds"
                              :disabled="selectDisabled"
                            >
                              <option disabled>(Select one)</option>
