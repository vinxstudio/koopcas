      ...
      <nav class="navbar navbar-expand-lg p-0" id="toolbar">
        ...
        <ul class="navbar-nav ml-auto">
          <li class="nav-item">
            <!--added router-->
            <router-link
              v-bind:to="'/deposits/sdsearch/'+client.clientId+'/inquiry-savings-search'"
            ...
            <!--added v-else-->
            <router-link
              to="/deposits/inquiry-savings-search"
              class="btn btn-sm btn-outline-primary mr-4"
              v-else
            >
              <i class="fa fa-search mr-1"></i>
    ...
    <form @submit.prevent="insertSd">
        ...
        <div class="col">
          <fieldset class="border p-2 bg-light">
            ...
            <div class="form-row align-items-stretch">
              <!-- <input type="hidden" v-model="savingsdeposit.sdBrCode" name="sdBrCode">
              <input type="hidden" v-model="savingsdeposit.sdSlcCode" name="sdSlcCode">-->
              <div class="col-md-7">
      ...
      <div class="d-flex justify-content-center" style="margin-bottom: 20px; margin-top: 20px;">
        ...
        <button
          ...
          @click="cancel"
        >
          <router-link to="/deposits/inquiry-savings" class="new" :disabled="selectDisabled">
            <i class="fa fa-times-circle mr-1"></i>
            <span>
              Canc
              <u>e</u>l
...
export default {
  ...
  methods: {
    ...
    //            }, 2000),
    //              console.log("Savings Deposit Added");
    //          })
    //          .catch(err => console.log(err));
    //      } else {
    //        fetch("/api/sd", {
    ...
    //            }, 2000),
    //              console.log("Savings Deposit Update");
    //            this.fetchSdById(
